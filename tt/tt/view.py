...
def delete_course(request):
    cid = request.GET['cid']
    dbe, cmd = pool.ConnectionPool()
    q = "delete from timetable.courses where course_code = '{}'".format(cid)
    cmd.execute(q)
    dbe.commit()
    dbe.close()
...
def delete_program(request):
    id = request.GET['id']
    dbe, cmd = pool.ConnectionPool()
    q = "delete from timetable.program where Program_name = '{}'".format(id)
    cmd.execute(q)
    dbe.commit()
    dbe.close()
...
def delete_faculty(request):
    id = request.GET['id']
    dbe, cmd = pool.ConnectionPool()
    q = "delete from timetable.professor where Professor_id = '{}'".format(id)
    cmd.execute(q)
    dbe.commit()
    dbe.close()
...
def delete_lectureroom(request):
    id = request.GET['id']
    dbe, cmd = pool.ConnectionPool()
    q = "delete from timetable.lecture where lecture_id = '{}'".format(id)
    cmd.execute(q)
    dbe.commit()
    dbe.close()
...
def delete_labroom(request):
    id = request.GET['id']
    dbe, cmd = pool.ConnectionPool()
    q = "delete from timetable.lab where Lab_id = '{}'".format(id)
    cmd.execute(q)
    dbe.commit()
    dbe.close()
